...
var content = $('<div class="timepicker">\
		<div v-show class="title">Alege ora</div>\
			<div class="chose-all">\
				<div class="handle">\
				...
				<div class="text">\
					<div class="cell-4"><a class="js-hour-show" title="Ora"></a></div>\
					<div class="cell-2">:</div>\
					<div class="cell-4"><a class="js-minute-show" title="Minut"></a></div>\
				</div>\
				<div class="handle">\
...
timepicker.bindEvent = function () {
	...
	// 选择分钟
		...
		thisTimePicker.title.text('Alege ora');
	...
	thisTimePicker.minuteShow.on('click',function() {
		...
		thisTimePicker.title.text('Alege minutul');
	});
};
