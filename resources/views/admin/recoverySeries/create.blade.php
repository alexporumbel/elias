                ...
                <div class="row">
                    ...
                    <div class="col-6 offset-3">
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form method="POST" action="{{ route('recoveryseries.store') }}">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('start_datetime') is-invalid @enderror datetimepicker-input" id="datetimepicker1" data-toggle="datetimepicker" data-target="#datetimepicker1" type="text" value="{{ old('start_datetime') }}"  name="start_datetime">
                                        @error('start_datetime')
                                        <p class="error invalid-feedback">{{ $errors->first('start_datetime') }}</p>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Data sfarsit</label>
                                        <input class="form-control @error('end_datetime') is-invalid @enderror datetimepicker-input" id="datetimepicker2" data-toggle="datetimepicker" data-target="#datetimepicker2" type="text" value="{{ old('end_datetime') }}"  name="end_datetime" id="end_datetime">
                                        @error('end_datetime')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('capacity') is-invalid @enderror" type="text" value="{{ old('capacity') }}"  name="capacity" id="capacity">
                                        @error('capacity')
